...
// uncomment portions of addLesson and deleteLesson
    ...
    deleteLesson: (state, { payload }) => {
      console.log("pressed delete lesson", state, payload);
...
export const { addModule, deleteModule, updateModule, editModule, addLessonToModule, deleteLesson, setModules } =
