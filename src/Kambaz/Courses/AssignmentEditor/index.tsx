...
export function AssignmentEditor() { //{ assignment }
 ...
 const saveAssignment = async (assignment: any) => {
  ...
  //   if (!cid) return;
  //   const newAssignment = { name: existingAssignment.title, course: cid };
  ...
  return (
    <div className="container mt-4">
      ...
      <Form>
        ...
        <Button variant="primary" onClick={() => saveAssignment(existingAssignment)}>
          Save
        </Button>
